...
sign_define('LspDiagnosticsErrorSign', {text = '×', texthl = 'LspDiagnosticsError'})
sign_define('LspDiagnosticsWarningSign', {text = '!', texthl = 'LspDiagnosticsWarning'})
sign_define('LspDiagnosticsInformationSign', {text = '●', texthl = 'LspDiagnosticsInformation'})
sign_define('LspDiagnosticsHintSign', {text = ' ', texthl = 'LspDiagnosticsHint'})
